...
from  Educationmanagement import settings
urlpatterns = [
    ...
    path('QuizHome',views.takeexam),
    path('quizindex',views.quizindex),
    path('student_courses',views.student_courses,name='student_courses'),
    path('student_register_course/<int:cid>',views.student_register_course,name="student_register_course"),
    ...
    path('insert_course_teacher',views.insert_course_teacher,name="insert_course_teacher"),
    path('teacher_delete_course/<int:id>',views.teacher_delete_course,name="teacher_delete_course"),
    path('upload_book/',views.upload,name="upload"),
    path('view_book/',views.view_books,name="view"),
    path('insert_quiz_result/',views.insert_quiz_result,name="insert_quiz_result"),
    path('quiz_analytics/',views.average_quiz_analytics,name="quiz_analytics"),
    path('filter_quiz_analytics/',views.quiz_analytics_filter,name="filter_quiz_analytics"),
    path('parent/',views.parent,name="parent"),
    path('view_children/<str:ph>',views.view_children,name="view_children"),
    path('insert_parent/',views.insert_parent,name="insert_parent"),
    path('add_parent/',views.add_parent,name="add_parent"),
    path('parent_login/',views.parent_login,name="parent_login"),
    path('validate_parent/',views.validate_parent,name="validate_parent"),
    path('parent_view_attendance/<str:phone>',views.parent_view_attendance,name="parent_view_attendance"),
    path('parent_view_attendance_filtered/<str:roll>',views.parent_view_attendance_filtered,name="parent_view_attendance_filtered"),
    path('parent_view_quizresult/<str:phone>',views.parent_view_quizresult,name="parent_view_quizresult"),
    path('parent_view_quizresult_filtered/<str:roll>',views.parent_view_quizresult_filtered,name="parent_view_quizresult_filtered"),
    path('smsalert/',views.smsalert,name="smsalert"),
    path('sendsms/',views.sendsms,name="sendsms"),
    path('insert_sms/',views.insert_sms,name="insert_sms"),
